class Product {
  ...
  static const List<Product> popularProducts = [
    Product(
      name: 'Cake',
      image: 'assets/images/popular/pinkCake.jpg',
      description:
    ...
    Product(
        name: 'Pizza',
        image: 'assets/images/popular/slice.jpg',
        description:
    ...
    Product(
        name: 'Jollof Rice',
        image: 'assets/images/popular/jollof.jpg',
        description:
    ...
    Product(
        name: "Cup Cake",
        image: 'assets/images/popular/cupcake.jpg',
        description:
    ...
    Product(
        name: 'Spring Rolls',
        image: 'assets/images/popular/springroll.jpg',
        description:
  ...
  static const List<Product> recommendedProducts = [
    Product(
        name: 'Salad',
        image: 'assets/images/recommended/salad.jpg',
        description:
    ...
    Product(
        name: 'Fried Chips',
        image: 'assets/images/recommended/friedchips.jpg',
        description:
    ...
    Product(
        name: 'Pie',
        image: 'assets/images/recommended/pie.jpg',
        description:
