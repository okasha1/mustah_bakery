...
class RecommendedProductDetail extends StatefulWidget {
  ...
  @override
  State<RecommendedProductDetail> createState() =>
      _RecommendedProductDetailState();
}

class _RecommendedProductDetailState extends State<RecommendedProductDetail> {
  int itemCount = 1;
